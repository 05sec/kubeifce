...
func (b *VlanStatusApplyConfiguration) WithState(value string) *VlanStatusApplyConfiguration {
	b.State = &value
	return b
}
...
func (b *VlanStatusApplyConfiguration) WithName(value string) *VlanStatusApplyConfiguration {
	b.Name = &value
	return b
}
...
func (b *VlanStatusApplyConfiguration) WithConditions(values ...*v1.ConditionApplyConfiguration) *VlanStatusApplyConfiguration {
	for i := range values {
		if values[i] == nil {

...
// apply.
func Vlan(name, namespace string) *VlanApplyConfiguration {
...
func (b *VlanApplyConfiguration) WithCreationTimestamp(value metav1.Time) *VlanApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *VlanApplyConfiguration) WithDeletionTimestamp(value metav1.Time) *VlanApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *VlanApplyConfiguration) WithOwnerReferences(values ...*v1.OwnerReferenceApplyConfiguration) *VlanApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {

...
type VlanInterface interface {
	...
	Apply(ctx context.Context, vlan *ifcev1.VlanApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Vlan, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, vlan *ifcev1.VlanApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Vlan, err error)
	VlanExpansion
}

// vlans implements VlanInterface
type vlans struct {
	*gentype.ClientWithListAndApply[*v1.Vlan, *v1.VlanList, *ifcev1.VlanApplyConfiguration]
}

// newVlans returns a Vlans
func newVlans(c *IfceV1Client, namespace string) *vlans {
	return &vlans{
		gentype.NewClientWithListAndApply[*v1.Vlan, *v1.VlanList, *ifcev1.VlanApplyConfiguration](
			"vlans",
			c.RESTClient(),
